...
def main():
    ...
    main_single(dog_size=11,dog_sigma_1=0.3,dog_sigma_2=1,dog_partitions=3,conv_padding=True,conv_stride=1,conv_kp=0.2)
    main_single(dog_size=15,dog_sigma_1=0.3,dog_sigma_2=1,dog_partitions=3,conv_padding=True,conv_stride=1,conv_kp=0.2)
    main_single(dog_size=19,dog_sigma_1=0.3,dog_sigma_2=1,dog_partitions=3,conv_padding=True,conv_stride=1,conv_kp=0.2)
    main_single(dog_size=23,dog_sigma_1=0.3,dog_sigma_2=1,dog_partitions=3,conv_padding=True,conv_stride=1,conv_kp=0.2)
